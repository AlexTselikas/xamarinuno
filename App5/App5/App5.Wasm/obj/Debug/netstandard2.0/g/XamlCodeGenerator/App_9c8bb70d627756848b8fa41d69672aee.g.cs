...
namespace App5
{
	...
	public partial class App : Windows.UI.Xaml.Application
	{
		private void InitializeComponent()
		{
			...
			.Apply((c0 => 
			{
				// Source C:\Users\alexa\source\repos\App5\App5\App5.Shared\App.xaml (Line 1:2)
			...
			global::App5.Wasm.GlobalStaticResources.Initialize();
			global::App5.Wasm.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::App5.Wasm.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::App5.Wasm.Resource.Drawable);
			#endif
			// Source ..\..\..\..\..\..\..\App5.Shared\App.xaml (Line 1:2)
		}
...
namespace App5.Wasm
{
	static class App_9c8bb70d627756848b8fa41d69672aeeXamlApplyExtensions
	{
	}
}
